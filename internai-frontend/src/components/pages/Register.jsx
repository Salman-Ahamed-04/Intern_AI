...
import { Zap, Eye, EyeOff, GraduationCap, Building2 } from "lucide-react";
    ...
    <div style={{
      ...
      <div style={{ width:"100%", maxWidth:440, padding:24 }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10, marginBottom:20 }}>
          {[
            { value:"student", label:"I'm a Student", icon: GraduationCap, sub:"Looking for internships" },
            { value:"company", label:"I'm a Company", icon: Building2,     sub:"Hiring interns" },
            ...
            <button
              ...
              style={{
                padding:"14px 12px", borderRadius:10, border:`2px solid ${role === value ? "var(--primary)" : "var(--border-color)"}`,
                background: role === value ? "var(--primary-light)" : "var(--surface)",
                cursor:"pointer", textAlign:"center", transition:"all 0.15s"
              }}
            >
              <Icon size={22} style={{ color: role === value ? "var(--primary)" : "var(--text-muted)", marginBottom:6 }}/>
              <div style={{ fontSize:13, fontWeight:600, color: role === value ? "var(--primary)" : "var(--text)" }}>{label}</div>
            ...
            <div>
              ...
              <div style={{ position:"relative" }}>
                <input className="input" type={show ? "text" : "password"} placeholder="Min. 6 characters" required
                  value={form.password} onChange={e => set("password", e.target.value)} style={{ paddingRight:36 }}/>
